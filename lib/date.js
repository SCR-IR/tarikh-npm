...
const change_persian = (change, dateTime = null) => {
  ...
  _julianDay += ch_day + persian_to_julianDay(year, month, day);
  ...
  return {
    ...
    toString: () => ('' + year + '/' + month + '/' + day + ' , ' + hour + ':' + minute + ':' + second + ':' + miliSecond)
  };
}
...
const change_gregorian = (change, dateTime = null) => {
  ...
  _julianDay += ch_day + gregorian_to_julianDay(year, month, day);
...
const change_islamic = (change, dateTime = null) => {
  ...
  _julianDay += ch_day + islamic_to_julianDay(year, month, day);
...
const change_islamicA = (change, dateTime = null) => {
  ...
  _julianDay += ch_day + islamicA_to_julianDay(year, month, day);
...
const roozeHaftehName = new Proxy(
