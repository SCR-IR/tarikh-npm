...
const hezaromeSaniyehShomar_be_zaman = (hezaromeSaniyehShomar) => {
  let {
    hour: saat, minute: daghigheh, second: saniyeh, miliSecond: hezaromeSaniyeh,
    toArray
  } = miliSeconds_to_time(hezaromeSaniyehShomar);
  return {
    saat, daghigheh, saniyeh, hezaromeSaniyeh, toArray
  };
}
...
export {
  change_persian,
  hezaromeSaniyehShomar_be_zaman,
